 ...
 */
final class Version20230422004822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, body LONGTEXT NOT NULL, INDEX IDX_B6BD307FF624B39D (sender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, poster_id INT NOT NULL, text LONGTEXT NOT NULL, total_likes INT NOT NULL, total_shares INT NOT NULL, INDEX IDX_5A8A6C8D5BB66C05 (poster_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post_share (post_id INT NOT NULL, member_id INT NOT NULL, INDEX IDX_781D11B54B89032C (post_id), INDEX IDX_781D11B57597D3FE (member_id), PRIMARY KEY(post_id, member_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
