 ...
 */
final class Version20230428194741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE person (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, phone INT NOT NULL, is_admin TINYINT(1) NOT NULL, person_type VARCHAR(255) NOT NULL, INDEX IDX_34DCD176F5B7AF75 (address_id), UNIQUE INDEX UNIQ_34DCD176A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
